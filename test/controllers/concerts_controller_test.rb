...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { description: @concert.description, name: @concert.name, release_date: @concert.release_date }
    end
  ...
  test "should update concert" do
    patch :update, id: @concert, concert: { description: @concert.description, name: @concert.name, release_date: @concert.release_date }
    assert_redirected_to concert_path(assigns(:concert))
  end
